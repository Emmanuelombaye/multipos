...
export function POSScreen({ branchId, cashierName }: POSScreenProps) {
  ...
  // Notify parent when cart sheet opens/closes to fade bottom nav
  useEffect(() => {
    const event = new CustomEvent('cartSheetToggle', { detail: { isOpen: showCartSheet } });
      ...
      <TabsContent value="sale" className="flex-1 overflow-hidden m-0 p-0">
        <div className="flex flex-col lg:flex-row h-full gap-0 lg:gap-4 p-0 lg:p-4 bg-neutral-50 overflow-hidden relative">
          ...
          <Sheet open={showCartSheet} onOpenChange={setShowCartSheet}>
            <SheetContent side="bottom" className="h-screen p-0 rounded-t-[1.5rem] border-t-0 bg-neutral-50 overflow-hidden flex flex-col focus:ring-0">
              ...
              <div className="p-4 pb-8 bg-white border-t space-y-3 shadow-[0_-10px_30px_rgba(0,0,0,0.05)] shrink-0">
